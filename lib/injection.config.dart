...
import 'package:FantasyE/application/auth/auth_form/auth_bloc.dart' as _i22;
...
import 'package:FantasyE/domain/manage_account/i_manage_account_facade.dart'
    as _i10;
import 'package:FantasyE/infrastructure/auth/api_client.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i6.ILeagueRepository>(
        () => _i7.LeagueRepository(gh<_i4.ApiClient>()));
    ...
    gh.lazySingleton<_i10.IManageAccountFacade>(
        () => _i11.AccountManagementRepository(apiClient: gh<_i5.ApiClient>()));
    gh.factory<_i12.LeagueWatcherBloc>(
        () => _i12.LeagueWatcherBloc(gh<_i6.ILeagueRepository>()));
    gh.factory<_i13.LeagueManagerBloc>(
        () => _i13.LeagueManagerBloc(gh<_i6.ILeagueRepository>()));
    gh.factory<_i14.AddAvatarBloc>(
        () => _i14.AddAvatarBloc(gh<_i8.IAvatarRepository>()));
    gh.lazySingleton<_i15.IAuthFacade>(
        () => _i16.AuthRepository(apiClient: gh<_i5.ApiClient>()));
    gh.factory<_i17.AvatarWatcherBloc>(
        () => _i17.AvatarWatcherBloc(gh<_i8.IAvatarRepository>()));
    gh.factory<_i18.AvatarManagerBloc>(
        () => _i18.AvatarManagerBloc(gh<_i8.IAvatarRepository>()));
    ...
    gh.factory<_i21.AuthLogicBloc>(
        () => _i21.AuthLogicBloc(gh<_i15.IAuthFacade>()));
    gh.factory<_i22.SignupFormBloc>(
        () => _i22.SignupFormBloc(gh<_i15.IAuthFacade>()));
    gh.factory<_i22.LoginFormBloc>(
        () => _i22.LoginFormBloc(gh<_i15.IAuthFacade>()));
    return this;
  }
}
