...
import 'package:FantasyE/application/auth/auth_bloc.dart' as _i14;
...
import 'package:FantasyE/application/avatar/delete_avatar/delete_avatar_bloc.dart'
    as _i8;
import 'package:FantasyE/domain/auth/i_auth_facade.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.IAuthFacade>(
        () => _i13.AuthRepository(apiClient: gh<_i3.ApiClient>()));
    gh.factory<_i14.SignupFormBloc>(
        () => _i14.SignupFormBloc(gh<_i12.IAuthFacade>()));
    gh.factory<_i14.LoginFormBloc>(
        () => _i14.LoginFormBloc(gh<_i12.IAuthFacade>()));
    return this;
  }
}
